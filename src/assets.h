...
extern const u_int8_t asset_BookPage_html[];
extern const u_int32_t asset_len_BookPage_html;
extern const time_t asset_mtime_BookPage_html;
extern const char *asset_sha256_BookPage_html;
int asset_serve_BookPage_html(struct http_request *);
